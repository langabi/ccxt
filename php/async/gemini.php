...
class gemini extends Exchange {
    ...
    public function fetch_markets_from_web($params = array ()) : Generator {
        yield;
    ...
    public function fetch_ticker_v1($symbol, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
    ...
    public function fetch_ticker_v2($symbol, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        $request = array(
    ...
    public function fetch_ticker_v1_and_v2($symbol, $params = array ()) : Generator {
        yield;
