...
class idex extends Exchange {
    ...
    public function fetch_orders_helper($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $request = array(
            'nonce' => $this->uuidv1(),
    ...
    public function associate_wallet($walletAddress, $params = array ()) : Generator {
        yield;
        $nonce = $this->uuidv1();
