...
class kucoin extends Exchange {
    ...
    public function load_time_difference($params = array ()) : Generator {
        yield;
    ...
    public function fetch_funding_fee($code, $params = array ()) : Generator {
        yield;
    ...
    public function fetch_ohlcv($symbol, $timeframe = '15m', $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        $marketId = $market['id'];
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetMarketOrderbookLevelLevel (array_merge($request, $params));
        //
        // 'market/orderbook/level2'
        // 'market/orderbook/level2_20'
        // 'market/orderbook/level2_100'
