...
class oceanex extends Exchange {
    ...
    public function fetch_tickers($symbols = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetTickersMulti (array_merge($request, $params));
        //
        //     {
        //         "code":0,
        //         "message":"Operation successful",
    ...
    public function fetch_order_books($symbols = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetOrderBookMulti (array_merge($request, $params));
        //
        //     {
        //         "code":0,
        //         "message":"Operation successful",
    ...
    public function fetch_all_trading_fees($params = array ()) : Generator {
        yield;
    ...
    public function fetch_key($params = array ()) : Generator {
        yield;
        $response = yield $this->privateGetKey ($params);
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetOrdersFilter (array_merge($request, $query));
        $data = $this->safe_value($response, 'data', array());
        $result = array();
        for ($i = 0; $i < count($data); $i++) {
    ...
    public function create_orders($symbol, $orders, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        $request = array(
        ...
        $response = yield $this->privatePostOrdersMulti (array_merge($request, $params));
        $data = $response['data'];
    ...
    public function cancel_all_orders($symbol = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $response = yield $this->privatePostOrdersClear ($params);
        $data = $this->safe_value($response, 'data');
        return $this->parse_orders($data);
    }
