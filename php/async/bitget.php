...
class bitget extends Exchange {
    ...
    public function fetch_trades($symbol, $limit = null, $since = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        $request = array(
    ...
    public function find_account_by_type($type) : Generator {
        yield;
        yield $this->load_markets();
    ...
    public function get_account_id($params) : Generator {
        yield;
        yield $this->load_markets();
        yield $this->load_accounts();
    ...
    public function fetch_position($symbol, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        $request = array(
    ...
    public function fetch_positions($symbols = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
