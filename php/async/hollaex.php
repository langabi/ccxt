...
class hollaex extends Exchange {
    ...
    public function fetch_markets($params = array ()) : Generator {
        yield;
        $response = yield $this->publicGetConstant ($params);
        //
        //     {
        //         coins => array(
        //             xmr => array(
    ...
    public function fetch_tickers($symbols = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $response = yield $this->publicGetTickerAll (array_merge($params));
        //
        //     {
        //         "bch-usdt" => array(
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1h', $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        $request = array(
    ...
    public function fetch_open_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetUserOrdersOrderId (array_merge($request, $params));
        //
        //     {
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostOrder (array_merge($order, $params));
        //
        //     {
        //         "$symbol" => "xht-usdt",
        //         "$side" => "sell",
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateDeleteUserOrdersOrderId (array_merge($request, $params));
        //
        //     {
        //         "title" => "string",
        //         "$symbol" => "xht-usdt",
    ...
    public function cancel_all_orders($symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateDeleteUserOrders (array_merge($request, $params));
        //
        //     array(
        //         {
        //             "title" => "string",
