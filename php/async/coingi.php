...
class coingi extends Exchange {
    ...
    public function fetch_markets($params = array ()) : Generator {
        yield;
        $response = yield $this->wwwGet ($params);
    ...
    public function fetch_balance($params = array ()) : Generator {
        ...
        $response = yield $this->userPostBalance (array_merge($request, $params));
    ...
    public function fetch_order_book($symbol, $limit = 512, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
    ...
    public function fetch_tickers($symbols = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $response = yield $this->currentGet24hourRollingAggregation ($params);
        $result = array();
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->currentGetTransactionsPairMaxCount (array_merge($request, $params));
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        $response = yield $this->userPostAddOrder (array_merge($request, $params));
        return array(
            'info' => $response,
            'id' => $response['result'],
        );
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        return yield $this->userPostCancelOrder (array_merge($request, $params));
    }
    ...
    public function request($path, $api = 'current', $method = 'GET', $params = array (), $headers = null, $body = null) : Generator {
        yield;
