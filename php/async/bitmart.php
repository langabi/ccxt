...
class bitmart extends Exchange {
    ...
    public function fetch_spot_markets($params = array ()) : Generator {
        yield;
    ...
    public function fetch_contract_markets($params = array ()) : Generator {
        yield;
    ...
    public function fetch_transactions_by_type($type, $code = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        if ($limit === null) {
            $limit = 50; // max 50
