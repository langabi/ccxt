...
class bitz extends Exchange {
    ...
    public function fetch_markets($params = array ()) : Generator {
        yield;
        $response = yield $this->marketGetSymbolList ($params);
        //
        //     {    status =>    200,
        //             msg =>   "",
    ...
    public function fetch_balance($params = array ()) : Generator {
        ...
        $response = yield $this->assetsPostGetUserAssets ($params);
        //
        //     {
        //         status => 200,
        //         msg => "",
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        $response = yield $this->marketGetTicker (array_merge($request, $params));
        //
        //     {    status =>    200,
        //             msg =>   "",
    ...
    public function fetch_tickers($symbols = null, $params = array ()) : Generator {
        ...
        $response = yield $this->marketGetTickerall (array_merge($request, $params));
        //
        //     {    status =>    200,
        //             msg =>   "",
    ...
    public function fetch_time($params = array ()) : Generator {
        yield;
        $response = yield $this->marketGetGetServerTime ($params);
        //
        //     {
        //         "status":200,
        //         "msg":"",
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->marketGetOrder (array_merge($request, $params));
        //
        //     {    status =>    200,
        //             msg =>   "",
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1m', $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->marketGetKline (array_merge($request, $params));
        //
        //     {
        //         status => 200,
        //         msg => "",
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        $response = yield $this->tradePostAddEntrustSheet (array_merge($request, $params));
        //
        //     {
        //         "status" => 200,
        //         "msg" => "",
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->tradePostCancelEntrustSheet (array_merge($request, $params));
        //
        //     {
        //         "status":200,
        //         "msg":"",
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->tradePostGetEntrustSheetInfo (array_merge($request, $params));
        //
        //     {
        //         "status":200,
        //         "msg":"",
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        return yield $this->fetch_orders_with_method('tradePostGetUserHistoryEntrustSheet', $symbol, $since, $limit, $params);
    }

    public function fetch_open_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        return yield $this->fetch_orders_with_method('tradePostGetUserNowEntrustSheet', $symbol, $since, $limit, $params);
    }
    ...
    public function fetch_deposits($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        return yield $this->fetch_transactions_for_type('deposit', $code, $since, $limit, $params);
    }

    public function fetch_withdrawals($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        return yield $this->fetch_transactions_for_type('withdrawal', $code, $since, $limit, $params);
    }

    public function fetch_transactions_for_type($type, $code = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        if ($code === null) {
        ...
        $response = yield $this->tradePostDepositOrWithdraw (array_merge($request, $params));
    ...
    public function withdraw($code, $amount, $address, $tag = null, $params = array ()) : Generator {
        ...
        $response = yield $this->tradePostCoinOut (array_merge($request, $params));
        //
        //     {
        //         "status":200,
        //         "msg":"",
