...
class coinegg extends Exchange {
    ...
    public function fetch_markets($params = array ()) : Generator {
        ...
        for ($b = 0; $b < count($quoteIds); $b++) {
            $quoteId = $quoteIds[$b];
            $response = yield $this->webGetSymbolTickerRightCoinQuote (array(
                'quote' => $quoteId,
            ));
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetTickerRegionQuote (array_merge($request, $params));
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetOrdersRegionQuote (array_merge($request, $params));
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostTradeAddRegionQuote (array_merge($request, $params));
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        return yield $this->privatePostTradeCancelRegionQuote (array_merge($request, $params));
    }
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostTradeViewRegionQuote (array_merge($request, $params));
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostTradeListRegionQuote (array_merge($request, $params));
        $data = $this->safe_value($response, 'data', array());
